...
class Api {
  ...
  // 删除单个depot信息
  static delteSingeldepot(String pk, String T) {
    Map<String, dynamic> headers = {
      HttpHeaders.authorizationHeader: 'Bearer $T',
      HttpHeaders.acceptHeader: 'application/json, text/plain, */*',
    };
    return Request.delete('/depot/$pk/', headrers: headers);
  }
  ...
  static addDepot(dynamic data, String T) {
    Map<String, dynamic> headers = {
      HttpHeaders.authorizationHeader: 'Bearer $T',
      HttpHeaders.acceptHeader: 'aprplication/json, text/plain, */*',
    };
    return Request.post('/depot/', data: data, headrers: headers);
  }
